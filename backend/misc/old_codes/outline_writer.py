...
Return ONLY the JSON output, with no additional text or explanation. Ensure your response is a valid JSON string that can be parsed using Python's json.loads()."""
