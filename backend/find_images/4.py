...
def update_section_with_image(client: OpenAI, section_title: str, section_content: str, image_data: dict, original_quote: str) -> str:
    ...
    Please integrate the following image next to the relevant quote on the right side. 
    IMPORTANT:
    ...
    Leave the latex formula as it is! Don't add anything.
    You should only add this new image before to its corresponding quote while keeping all other images in their current positions. Remeber to keep a distance of 2 paragraphs from <div class="related-topics"> or <div class="example-box" style="clear: both;">

    CRITICAL HTML STRUCTURE REQUIREMENTS:
    1. Images should be placed in a Wikipedia-style box with this exact structure:
    <figure style="float: right; clear: right; margin: 0 0 20px 20px; max-width: 30%; background-color: #f8f9fa; border: 1px solid #a2a9b1; padding: 8px; box-sizing: border-box;">
        <div style="background-color: #f8f9fa; text-align: center; padding: 5px;">
            <img src="{image_data['link']}" alt="{image_data['explanation']}" style="width: 100%; height: auto; display: block; margin: 0 auto;"/>
        </div>
...
#NEW TEXTS START HERE
Start the text that follows in a new line at the very front!

    2. Always include 'clear: right' in the figure style to prevent floating conflicts
    3. The source should be a clickable button that opens in a new tab
